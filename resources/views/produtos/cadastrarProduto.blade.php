                                    ...
                                    <tbody>
                                        @foreach ($produtos as $produto)
                                            <tr>
                                                <td>
                                                    <div class="products">
                                                        <img src="/site/img/produtos/{{ $produto->imagem }}" class="avatar avatar-md"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td><h6>{{ $produto->nome }}</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 mb-3">
                            <label for="preco" class="form-label">Preço<span
                                    class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="exampleFormControlInput2" name="preco" placeholder="">
                        </div>
                        {{-- <div class="col-xl-6 mb-3">
                        ...
                        <div class="col-xl-12 mb-6">
                            <label class="form-label" for="descricao">Descrição do produto<span class="text-danger">*</span></label>
