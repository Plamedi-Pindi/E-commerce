                            ...
                            <div class="table-responsive active-projects style-1">
                                <div class="tbl-caption">
                                    <div class="prod-form-header col-md-12">
                                        <h4 class="modal-title" id="#gridSystemModal">Produto a ser editado: {{ $produto->nome }}</h4>
                                        <hr>
                                    </div>
                                    ...
                                    <div class="prod-form-body col-md-10">
                                        <div class="container-fluid">
                                            ...
                                            <form action="/atualizar/{{ $produto->id }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="row">
                                                    <div>
                                                        ...
                                                        <div class="dz-default dlab-message upload-img mb-3">
                                                            <div class="dropzone">
                                                                ...
                                                                <div class="fallback">
                                                                    <input name="imagem" id="imagem" type="file" multiple  class="form-control" style="display: inline;" required value="{{ $produto->imagem }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-3 mb-3">
                                                        <label for="estoque" class="form-label">Estoque<span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" class="form-control" name="quantidade" id="exampleFormControlInput3" value="{{ $produto->estoque->quantidade }}">
                                                    </div>
                                                    <div class="col-xl-3 mb-3">
                                                        <label for="estoque" class="form-label">Limite Mínimo<span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" class="form-control" name="limite_min" id="exampleFormControlInput3" value="{{ $produto->estoque->limite_min }}">
                                                    </div>

                                                    <div class="col-xl-6 mb-3">
                                                        <label class="form-label">Categoria<span class="text-danger">*</span></label>
                                                        <select class=" form-control" name="categoria">
                                                            <option data-display="Select" value="{{ $produto->id_categoria }}">{{ $produto->categoria->nome }}</option>
                                                    ...
                                                    <div class="col-xl-6 mb-3">
                                                        <label for="estoque" class="form-label">Peso<span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" class="form-control" name="peso" id="exampleFormControlInput3" value="{{ $produto->peso }}">
                                                    </div>

                                                    <div class="col-xl-6 mb-3">
                                                        <label for="estoque" class="form-label">Data de Validade<span
                                                                class="text-danger">*</span></label>
                                                        <input type="date" class="form-control" name="validade" id="exampleFormControlInput3" value="{{ $produto->validade }}" required>
                                                    </div>
