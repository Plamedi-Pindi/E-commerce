                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="shoping__cart__btns">
                            ...
                            <a href="{{ route('shop.grid') }}" class="primary-btn cart-btn cart-btn-comprar">
                    ...
                    <div class="col-lg-6">
                        <div class="shoping__checkout">
                            ...
                            <a href="{{ route('site.checkout') }}" class="primary-btn">FAZER A COMPRA</a>
                        </div>
                    </div>
                </div>
            {{-- @endif --}}
