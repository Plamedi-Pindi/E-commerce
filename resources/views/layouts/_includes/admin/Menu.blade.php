    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div>
                    <img src="/site/img/icon.png" class="logo-icon" alt="logo icon">
                </div>
                <div>
                   <a href="{{ route('admin.home') }}"><h4 class="logo-text">Sumba</h4></a>
                </div>
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="{{ route('admin.pedidos.index') }}">
                        ...
                        <div class="menu-title">Pedidos de Clientes</div>
                    </a>
                </li>
                <li class="menu-label">Produtos</li>
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ route('admin.produtos.create') }}"><i class='bx bx-radio-circle'></i>Cadastrar
                                Produtos</a>
                        </li>
                        <li> <a href="{{ route('admin.produtos.index') }}"><i class='bx bx-radio-circle'></i>Listar
                                Produtos</a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ route('admin.categorias.create') }}"><i class='bx bx-radio-circle'></i>Cadastrar Categorias</a>
                        </li>
                        <li> <a href="{{ route('admin.categorias.index') }}"><i class='bx bx-radio-circle'></i>Listar Categorias</a>
                        </li>
                ...
                <li class="menu-label">Estatistica de Produtos</li>
                <li>
                    <a class="has-arrow" href="javascript:;">
                        <div class="parent-icon"><i class="bx bx-line-chart"></i>
                        </div>
                        <div class="menu-title">Estatística</div>
                    </a>
                    <ul>
                        <li> <a href="charts-apex-chart.html"><i class='bx bx-radio-circle'></i>Pedidos</a>
                        </li>
                        <li> <a href="charts-chartjs.html"><i class='bx bx-radio-circle'></i>Vendas</a>
                        </li>
                        <li> <a href="charts-highcharts.html"><i class='bx bx-radio-circle'></i> Mais Vendidos</a>
                        </li>
                    </ul>
                </li>

                <li class="menu-label">Utilizadores</li>
                <li>
                    <a href="javascript:;" class="has-arrow">
                    ...
                    <ul>
                        <li> <a href="app-emailbox.html"><i class='bx bx-radio-circle'></i>Criar</a>
                        </li>

                        <li> <a href="app-fullcalender.html"><i class='bx bx-radio-circle'></i>Listar</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ route('register') }}"><i class='bx bx-radio-circle'></i>Criar</a>
                        </li>

                        <li> <a href="{{ route('admin.user.index') }}"><i class='bx bx-radio-circle'></i>Listar</a>
                        </li>
                    </ul>
                </li>
                            ...
                            <li class="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img
                                                src="/dashboard2/assets/images/county/01.png" width="20"
