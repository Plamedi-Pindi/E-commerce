            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Utilizadores</div>
                    </a>
                    <ul>
                        <li> <a href="app-emailbox.html"><i class='bx bx-radio-circle'></i>Criar</a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ route('admin.products') }}"><i class='bx bx-radio-circle'></i>Produtos</a>
                        </li>
                        <li> <a href="ecommerce-products-details.html"><i class='bx bx-radio-circle'></i>Detalhes do produto</a>
                        </li>
                        <li> <a href="{{ route('admin.newproduct') }}"><i class='bx bx-radio-circle'></i>Novo produto</a>
                        </li>
                ...
                <li class="menu-label">Estatistica</li>
                <li>
