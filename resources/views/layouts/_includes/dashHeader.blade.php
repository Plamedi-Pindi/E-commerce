...
<head>
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="/site/img/icon.png">
        ...
        ***********************************-->
        <div class="nav-header">
            ...
            <a href="{{ route('home') }}" class="brand-logo">
                <img src="/site/img/icon.png" alt="" ><h2>Su<span>m</span>ba</h2>
            </a>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            {{-- Botao de Logout --}}
							<li class="nav-item align-items-center header-border"><a href="{{ route('user.logout') }}" class="btn btn-primary btn-sm">Logout</a></li>
