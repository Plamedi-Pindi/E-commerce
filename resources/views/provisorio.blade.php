<div>
    ...
    <div class="dz-default dlab-message upload-img mb-3">
        <div class="dropzone">
            ...
            <div class="fallback">
                <input name="imagem" id="imagem" type="file" multiple  class="form-control" style="display: inline;" value="{{ $produto->imagem }}">
                <img src="/site/img/produtos/{{ $produto->imagem }}" alt="{{ $produto->nome }}" >
            </div>
        </div>
    </div>
</div>
