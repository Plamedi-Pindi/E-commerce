                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive active-projects style-1">
                                ...
                                <div class="tbl-caption">
                                    ...
                                    <div>
                                        <a href="{{ route('admin.vendas') }}" type="button" class="btn btn-primary btn-sm"
                                ...
                                <table id="empoloyees-tblwrapper" class="table">
                                    ...
                                    <tbody>
                                        @foreach ($vendas as $venda)
                                            @if (auth()->user()->id == $venda->user->id && auth()->user()->tipoUsuario->id == 1)
                                            <tr>
                                                <td>
                                                    <span class="list-text ">{{ $venda->id }}</span>
                                                </td>
                                                <td><span class="text-primary">{{ $venda->user->firstName }} {{ $venda->user->lastName }}</span></td>
                                                <td>
                                                    <span class="list-text">{{ number_format($venda->totla, 2, ',', '.') }} Kz</span>
                                                </td>
                                                <td>
                                                    <span class="list-text">{{ $venda->created_at }}</span>
                                                </td>

                                                <td>
                                                    <span class=" list-text">{{ $venda->ref_pagamento }}</span>
                                                </td>
                                                <td>
