    ...
    <div class="page-content">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-lg-3 col-xl-2">
                                <a href="ecommerce-add-new-products.html" class="btn btn-primary mb-3 mb-lg-0 new-product-btn"><i
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 product-grid">
            @foreach ($produtos as $produto)
                <div class="col">
                    <a href="{{ route('adimn.productdetails', $produto->id) }}">
                        <div class="card">
                            <img src="/site/img/produtos/{{ $produto->imagem }}" class="card-img-top" alt="...">
                            <div class="">
                                <div class="position-absolute top-0 end-0 m-3 product-discount"><span class="">-10%</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <h6 class="card-title cursor-pointer">{{ $produto->nome }}</h6>
                                <div class="clearfix">
                                    <p class="mb-0 float-start"><strong>134</strong> vendidos</p>
                                    <p class="mb-0 float-end fw-bold"><span
                                            class="me-2 text-decoration-line-through text-secondary">3500kz</span><span>{{ number_format($produto->preco, 2, ',', '.') }} Kz</span>
                                    </p>
                                </div>
