        ...
        <div class="card">
            <div class="row g-0">
                <div class="col-md-4 border-end">
                    <img src="/site/img/produtos/{{ $produtos->imagem }}" class="img-fluid detail-img"
                        alt="Imagem do produto">
                    <div class="row mb-3 row-cols-auto g-2 justify-content-center mt-3">
                        <div class="col"><img src="/site/img/produtos/{{ $produtos->imagem }}" width="70"
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <div class="d-flex gap-3 mt-3">
                            <a href="#" class="btn btn-primary">Editar <i
                                class='bx bxs-edit-alt'></i> </a>
                            <a href="{{route("product.delete", $produtos->id)}}" class="btn btn-danger"><span class="text">Eliminar</span> <i
                                    class='bx bxs-delete-alt'></i></a>
                        </div>
                    </div>
                </div>
            </div>
