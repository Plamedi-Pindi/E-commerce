                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive active-projects style-1">
                                ...
                                <div class="tbl-caption">
                                     ...
                                     {{-- Barra de pesquisa --}}
                                     <form action="{{ route('admin.cliente') }}" method="GET"
                                    ...
                                    <div>
                                        <a href="{{ route('admin.cliente') }}" type="button" class="btn btn-primary btn-sm"
                                ...
                                <table id="empoloyees-tblwrapper" class="table">
                                    ...
                                    <tbody>
                                        @foreach ($clientes as $cliente)
                                            <tr>
                                                <td>
                                                    <span class="list-text ">{{ $cliente->id }}</span>
                                                </td>
                                                <td><span class="text-primary">{{ $cliente->firstName }} {{ $cliente->lastName }}</span></td>
                                                <td>
                                                    <span class="list-text">{{$cliente->genero }} </span>
                                                </td>
                                                <td>
                                                    <span class="list-text">{{ $cliente->email }}</span>
                                                </td>
                                                <td>
                                                    <span class="list-text">{{ $cliente->telefone }}</span>
                                                </td>
                                                <td>
